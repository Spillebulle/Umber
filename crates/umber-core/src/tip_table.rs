...
pub(crate) const TIPS: &[(&str, &[u8])] = &[
    ("deevad-c2-mechanical-pencil-detail-deevad-25-01", include_bytes!("../assets/tips/deevad-c2-mechanical-pencil-detail-deevad-25-01.png")),
    ("deevad-c4-bristles-lineart-deevad-25-01", include_bytes!("../assets/tips/deevad-c4-bristles-lineart-deevad-25-01.png")),
    ("deevad-c5-thin-brush-hard-edge-textured-deevad-25-01", include_bytes!("../assets/tips/deevad-c5-thin-brush-hard-edge-textured-deevad-25-01.png")),
    ("deevad-d-glazing-round-deevad-25-01", include_bytes!("../assets/tips/deevad-d-glazing-round-deevad-25-01.png")),
    ("deevad-f-rough-rake-textured-deevad-25-01", include_bytes!("../assets/tips/deevad-f-rough-rake-textured-deevad-25-01.png")),
    ("deevad-f-thick-dry-canvas-deevad-25-01", include_bytes!("../assets/tips/deevad-f-thick-dry-canvas-deevad-25-01.png")),
    ...
    ("raghukamath-pack01-drybrush", include_bytes!("../assets/tips/raghukamath-pack01-drybrush.png")),
    ("raghukamath-pack01-drybrush2", include_bytes!("../assets/tips/raghukamath-pack01-drybrush2.png")),
